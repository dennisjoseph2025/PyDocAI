    ...
    <div className="min-h-screen bg-bg-primary flex items-center justify-center px-4 relative z-10">
      ...
      <div className="glass-card w-full max-w-md p-6 sm:p-10 animate-fade-in relative z-10">
        <div className="text-center mb-6 sm:mb-8">
          ...
          <h1 className="font-display font-bold text-xl sm:text-2xl text-center mt-3 sm:mt-4 mb-1 sm:mb-2 text-ink-primary">Welcome back</h1>
          <p className="text-ink-secondary text-xs sm:text-sm text-center">Sign in to continue generating docs</p>
        </div>
