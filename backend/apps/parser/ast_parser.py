...
def parse_python_file(source_code: str) -> dict:
    ...
    result = {
        ...
        "functions": [],
        "classes": [],
        "ordered_items": []  # Preserves source order: [{"type": "import"|"function"|"class", "data": ...}]
    }

    # Collect all top-level names for cross-reference detection
    top_level_names = set()

    # First pass: collect top-level definitions to know what names exist
    ...
    # Second pass: ordered traversal of tree.body
    for node in tree.body:
